...
Yad is a macOS meeting transcription & summarization app built with Tauri 2.x (Rust backend + React/TypeScript frontend).
...
Yad supports command-line parameters on all platforms for integration with scripts, window managers, and autostart configurations.
