...
Thank you for your interest in contributing to Yad! This guide will help you get started with contributing to this open source meeting transcription & summarization application.

## 📖 Philosophy

Yad aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ...
   ```bash
   git clone git@github.com:YOUR_USERNAME/Yad.git
   cd Yad
   ```
...
3. **Add upstream remote**:
   ...
   ```bash
   git remote add upstream git@github.com:assaflavi/Yad.git
   ```
...
Yad follows a clean architecture pattern:
...
1. **Search existing issues** at [github.com/assaflavi/Yad/issues](https://github.com/assaflavi/Yad/issues)
2. **Check discussions** at [github.com/assaflavi/Yad/discussions](https://github.com/assaflavi/Yad/discussions)
...
1. **Search existing discussions** at [github.com/assaflavi/Yad/discussions](https://github.com/assaflavi/Yad/discussions)
2. **Check common feature requests**:
   - [Post-processing / Editing Transcripts](https://github.com/assaflavi/Yad/discussions/168)
   - [Keyboard Shortcuts / Hotkeys](https://github.com/assaflavi/Yad/discussions/211)

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/assaflavi/Yad/discussions)
...
4. Describe your feature idea including:
   ...
   - How it fits with Yad's philosophy
...
1. **Search existing issues and PRs** - Check both open AND closed issues and pull requests. Someone may have already addressed this, or there may be a reason it was closed.
   - [Open issues](https://github.com/assaflavi/Yad/issues)
   - [Closed issues](https://github.com/assaflavi/Yad/issues?q=is%3Aissue+is%3Aclosed)
   - [Open PRs](https://github.com/assaflavi/Yad/pulls)
   - [Closed PRs](https://github.com/assaflavi/Yad/pulls?q=is%3Apr+is%3Aclosed)
...
2. **If something was previously closed** - If you want to revisit a closed issue or PR, you need to:
   ...
   - Gather community feedback first via [Discussions](https://github.com/assaflavi/Yad/discussions)
   - Link to that discussion in your PR

3. **Get community feedback for features** - PRs with demonstrated community interest are **much more likely to be merged**. Start a discussion, get feedback, and link to it in your PR. This helps ensure Yad stays focused and useful for the most people without becoming bloated.

Community feedback is essential to keeping Yad the best it can be for everyone. It helps prioritize what matters most and prevents feature creep.
...
7. **Create a Pull Request**:
   - Go to the [Yad repository](https://github.com/assaflavi/Yad)
   ...
   **Remember:** PRs with community support are prioritized. If you haven't already, start a [discussion](https://github.com/assaflavi/Yad/discussions) to gather feedback before or alongside your PR. It is not explicitly required to gather feedback, but it certainly helps your PR get merged faster.
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/assaflavi/Yad/discussions)

## 📜 License

By contributing to Yad, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to Yad!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
